        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="<?= base_url('kategori/add') ?>" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newKategoriModal" class="btn btn-primary mb-3"><i class="fas fa-plus"></i>Tambah kategori</a>
